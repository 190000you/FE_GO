...
Future<void> fetchSurvey(
  ...
  final response = await http.post(
    Uri.parse('http://43.203.61.149/survey/enroll/$userId'),
  ...
  if (response.statusCode == 201) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      await SnackBar(
        content: Text("정보가 수정되었습니다!", style: GoogleFonts.oleoScript()),
...
class SurveyAgainPage extends StatefulWidget {
  @override
  _SurveyAgainPageState createState() => _SurveyAgainPageState();
}

class _SurveyAgainPageState extends State<SurveyAgainPage> {
