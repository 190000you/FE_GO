                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                              color: Colors.black, fontSize: 20.0), // 검은색 글씨
                        ),
                      ),
                    ],
                  ),
                  ...
                  if (index == 0) {
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        width: 200, // 원의 너비
                        margin:
                            EdgeInsets.symmetric(horizontal: 10), // 원 사이의 간격
                        decoration: BoxDecoration(
