              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text('이월드 상세보기', style: TextStyle(fontSize: 22)),
                  ),
                ),
                SizedBox(height: 50),
                Divider(),
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text('송해 공원 상세보기', style: TextStyle(fontSize: 22)),
                  ),
                ),
                SizedBox(height: 50),
                Divider(),
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text('앞산 공원 상세보기', style: TextStyle(fontSize: 22)),
                  ),
                ),
                SizedBox(height: 20),
                Divider(),
