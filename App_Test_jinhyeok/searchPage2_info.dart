      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 20),
            Text('분류: ${placeDetails['classification']}',
                style: GoogleFonts.oleoScript(fontSize: 18)),
            SizedBox(height: 20),
            Text('주차 여부: ${placeDetails['parking'] ? '가능' : '불가능'}',
                style: GoogleFonts.oleoScript(fontSize: 18)),
            SizedBox(height: 20),
            Text('평균 체류 시간: ${placeDetails['time']}',
                style: GoogleFonts.oleoScript(fontSize: 18)),
            SizedBox(height: 20),
            Text('자세한 정보: ${placeDetails['info']}',
                style: GoogleFonts.oleoScript(fontSize: 18)),
            SizedBox(height: 20),
            Text('전화번호: ${placeDetails['call']}',
                style: GoogleFonts.oleoScript(fontSize: 18)),
            SizedBox(height: 20),
            Text('태그',
